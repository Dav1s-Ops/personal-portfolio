    ...
    >
      ...
      <div className="hidden w-7/12 group-hover:block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        {link && (
          ...
          >
            <p className="text-center p-0.5 lg:p-2 rounded-lg mt-1 bg-dark_gray text-alien_green text-md hover:scale-105 duration-300 hover:bg-med_gray lg:hover:py-2">
              Website
            </p>
          </a>
        )}
