  ...
  return (
    <div className='font-mussels relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group ease-in duration-200 hover:bg-gradient-to-r from-gray-400 to-dark_gray'>
      ...
      <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
        ...
        <a href="/">
          <p className='text-center p-3 rounded-lg bg-white text-gray-700 text-lg hover:scale-105 ease-in duration-200 hover:bg-dark_gray hover:text-alien_green hover:px-3 hover:py-3 hover:rounded-md' >More Info</p>
        </a>
      </div>
    </div>
