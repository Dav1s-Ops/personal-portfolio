...
const ProjectItem = ({img, title, link, belink, felink, framework}) => {
  return (
    <div className='font-mussels relative flex md:ml-5 items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-t from-alien_green to-dark_gray hover:outline hover:outline-2 hover:outline-offset-1 hover:outline-alien_green'>
