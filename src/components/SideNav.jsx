      ...
      }
      {
        nav ? (
          ...
          <div className='font-mussels fixed w-full h-screen bg-white/90 flex flex-col justify-center items-center z-20'>
            <a 
              onClick={handleNav} 
              href='#main' className='w-[75%] flex justify-center items-center rounded-full shadow-lg  bg-gradient-to-b to-dark_gray from-med_gray text-alien_green shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-105 ease-in duration-200'>
          ...
          <div className='xl:block hidden fixed top-[25%] z-10 '>
            ...
            <a 
              href='#main' 
              className='group relative flex items-center justify-center rounded-full bg-gradient-to-b to-dark_gray from-med_gray hover:scale-110 m-5 p-4 cursor-pointer transition-all ease-in duration-300 w-14 h-14'
            ...
            >
              <div className='inline-flex justify-center items-center '>
                ...
                <span className='absolute left-7 w-0 overflow-hidden bg-gradient-to-b to-dark_gray from-med_gray rounded-r-full transition-all ease-in duration-200 group-hover:w-32 h-full flex items-center justify-center text-alien_green font-mussels text-opacity-0 group-hover:text-opacity-100'>Home</span>
              </div>
            </a>
            <a 
              href='#work' 
            ...
            >
              <div className='inline-flex justify-center items-center '>
                ...
                <span className='absolute left-7 w-0 overflow-hidden bg-gradient-to-b to-dark_gray from-med_gray  rounded-r-full transition-all ease-in duration-200 group-hover:w-32 h-full flex items-center justify-center text-alien_green font-mussels text-opacity-0 group-hover:text-opacity-100'>About</span>
              </div>
            </a>
            <a 
              href='#contact' 
